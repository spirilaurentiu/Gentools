...
parser.add_argument('--temp_name', type=str, help="Name of the temporary script we'll be using; if there already exists a file with this name, it will not work")
